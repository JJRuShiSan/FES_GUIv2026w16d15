...
namespace {
struct qt_meta_stringdata_SpiHandler_t {
    uint offsetsAndSizes[2];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SpiHandler_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SpiHandler_t qt_meta_stringdata_SpiHandler = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SpiHandler[] = {
...
Q_CONSTINIT const QMetaObject SpiHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_SpiHandler.offsetsAndSizes,
    qt_meta_data_SpiHandler,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SpiHandler_t,
        // Q_OBJECT / Q_GADGET
...
void *SpiHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SpiHandler.stringdata0))
